...
* Lancer le build et vérifiez que vos packages ont bien été installés.
...
![Premier Projet Camunda](img/tp3/camunda-first-proj.png)
...
![Configuration du déploiement](img/tp3/deploy.png)
